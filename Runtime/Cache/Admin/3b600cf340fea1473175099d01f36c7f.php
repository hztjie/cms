...
<!-- bootstrap - css -->
<link href="http://localhost/cms/Public/Plugins/BJUI/themes/css/bootstrap.css" rel="stylesheet">
<!-- core - css -->
<link href="http://localhost/cms/Public/Plugins/BJUI/themes/css/style.css" rel="stylesheet">
<link href="http://localhost/cms/Public/Plugins/BJUI/themes/blue/core.css" id="bjui-link-theme" rel="stylesheet">
<!-- plug - css -->
<link href="http://localhost/cms/Public/Plugins/BJUI/plugins/kindeditor_4.1.10/themes/default/default.css" rel="stylesheet">
<link href="http://localhost/cms/Public/Plugins/BJUI/plugins/colorpicker/css/bootstrap-colorpicker.min.css" rel="stylesheet">
<link href="http://localhost/cms/Public/Plugins/BJUI/plugins/niceValidator/jquery.validator.css" rel="stylesheet">
<link href="http://localhost/cms/Public/Plugins/BJUI/plugins/bootstrapSelect/bootstrap-select.css" rel="stylesheet">
<link href="http://localhost/cms/Public/Plugins/BJUI/themes/css/FA/css/font-awesome.min.css" rel="stylesheet">
<!--[if lte IE 7]>
<link href="http://localhost/cms/Public/Plugins/BJUI/themes/css/ie7.css" rel="stylesheet">
<![endif]-->
<!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
<!--[if lte IE 9]>
    <script src="http://localhost/cms/Public/Plugins/BJUI/other/html5shiv.min.js"></script>
    <script src="http://localhost/cms/Public/Plugins/BJUI/other/respond.min.js"></script>
<![endif]-->
<!-- jquery -->
<script src="http://localhost/cms/Public/Plugins/BJUI/js/jquery-1.7.2.min.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/js/jquery.cookie.js"></script>
<!--[if lte IE 9]>
<script src="http://localhost/cms/Public/Plugins/BJUI/other/jquery.iframe-transport.js"></script>    
<![endif]-->
<!-- BJUI.all 分模块压缩版 -->
<script src="http://localhost/cms/Public/Plugins/BJUI/js/bjui-all.js"></script>
<!-- 以下是B-JUI的分模块未压缩版，建议开发调试阶段使用下面的版本 -->
<!--
<script src="http://localhost/cms/Public/Plugins/BJUI/js/bjui-core.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/js/bjui-regional.zh-CN.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/js/bjui-frag.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/js/bjui-extends.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/js/bjui-basedrag.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/js/bjui-slidebar.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/js/bjui-contextmenu.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/js/bjui-navtab.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/js/bjui-dialog.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/js/bjui-taskbar.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/js/bjui-ajax.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/js/bjui-alertmsg.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/js/bjui-pagination.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/js/bjui-util.date.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/js/bjui-datepicker.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/js/bjui-ajaxtab.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/js/bjui-datagrid.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/js/bjui-tablefixed.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/js/bjui-tabledit.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/js/bjui-spinner.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/js/bjui-lookup.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/js/bjui-tags.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/js/bjui-upload.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/js/bjui-theme.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/js/bjui-initui.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/js/bjui-plugins.js"></script>
-->
<!-- plugins -->
<!-- swfupload for uploadify && kindeditor -->
<script src="http://localhost/cms/Public/Plugins/BJUI/plugins/swfupload/swfupload.js"></script>
<!-- kindeditor -->
<script src="http://localhost/cms/Public/Plugins/BJUI/plugins/kindeditor_4.1.10/kindeditor-all.min.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/plugins/kindeditor_4.1.10/lang/zh_CN.js"></script>
<!-- colorpicker -->
<script src="http://localhost/cms/Public/Plugins/BJUI/plugins/colorpicker/js/bootstrap-colorpicker.min.js"></script>
<!-- ztree -->
<script src="http://localhost/cms/Public/Plugins/BJUI/plugins/ztree/jquery.ztree.all-3.5.js"></script>
<!-- nice validate -->
<script src="http://localhost/cms/Public/Plugins/BJUI/plugins/niceValidator/jquery.validator.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/plugins/niceValidator/jquery.validator.themes.js"></script>
<!-- bootstrap plugins -->
<script src="http://localhost/cms/Public/Plugins/BJUI/plugins/bootstrap.min.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/plugins/bootstrapSelect/bootstrap-select.min.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/plugins/bootstrapSelect/defaults-zh_CN.min.js"></script>
<!-- icheck -->
<script src="http://localhost/cms/Public/Plugins/BJUI/plugins/icheck/icheck.min.js"></script>
<!-- dragsort -->
<script src="http://localhost/cms/Public/Plugins/BJUI/plugins/dragsort/jquery.dragsort-0.5.1.min.js"></script>
<!-- HighCharts -->
<script src="http://localhost/cms/Public/Plugins/BJUI/plugins/highcharts/highcharts.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/plugins/highcharts/highcharts-3d.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/plugins/highcharts/themes/gray.js"></script>
<!-- ECharts -->
<script src="http://localhost/cms/Public/Plugins/BJUI/plugins/echarts/echarts.js"></script>
<!-- other plugins -->
<script src="http://localhost/cms/Public/Plugins/BJUI/plugins/other/jquery.autosize.js"></script>
<link href="http://localhost/cms/Public/Plugins/BJUI/plugins/uploadify/css/uploadify.css" rel="stylesheet">
<script src="http://localhost/cms/Public/Plugins/BJUI/plugins/uploadify/scripts/jquery.uploadify.min.js"></script>
<script src="http://localhost/cms/Public/Plugins/BJUI/plugins/download/jquery.fileDownload.js"></script>
<!-- init -->
<script type="text/javascript">
$(function() {
    BJUI.init({
        JSPATH       : 'src="http://localhost/cms/Public/Plugins/BJUI/',         //[可选]框架路径
        PLUGINPATH   : 'src="http://localhost/cms/Public/Plugins/BJUI/plugins/', //[可选]插件路径
