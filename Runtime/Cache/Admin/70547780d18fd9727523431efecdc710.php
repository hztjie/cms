...
<script src="/cms/Public/Plugins/B-JUI/js/jquery-1.7.2.min.js"></script>
<script src="/cms/Public/Plugins/B-JUI/js/jquery.cookie.js"></script>
<script src="js/sha256.js"></script>
<link href="/cms/Public/Plugins/B-JUI/themes/css/bootstrap.min.css" rel="stylesheet">
<style type="text/css">
* {font-family: "Verdana", "Tahoma", "Lucida Grande", "Microsoft YaHei", "Hiragino Sans GB", sans-serif;}
body {
    background: url(/cms/Public/Images/loginbg_01.jpg) no-repeat center center fixed;
...
function choose_bg() {
	...
	$('body').css('background-image', 'url(/cms/Public/Images/loginbg_0'+ bg +'.jpg)');
}
</script>
</head>
<body>
        ...
        <div class="login_form">
    		...
    		<form action="index.html" id="login_form" method="post">
    			...
    			<div class="form-group">
    				...
    				<img id="captcha_img" alt="点击更换" title="点击更换" src="/cms/Public/Images/captcha.jpeg" class="m">
    			</div>
    			<div class="form-group">
                    <label class="t"></label>
