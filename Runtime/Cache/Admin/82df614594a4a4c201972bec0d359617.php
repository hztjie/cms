...
<script src="<?php echo PLUGIN_URL;?>/B-JUI/js/jquery-1.7.2.min.js"></script>
<script src="<?php echo PLUGIN_URL;?>/B-JUI/js/jquery.cookie.js"></script>
<link href="<?php echo PLUGIN_URL;?>/B-JUI/themes/css/bootstrap.min.css" rel="stylesheet">
<style type="text/css">
* {font-family: "Verdana", "Tahoma", "Lucida Grande", "Microsoft YaHei", "Hiragino Sans GB", sans-serif;}
body {
    background: url(<?php echo ADMIN_IMG_URL;?>/loginbg_01.jpg) no-repeat center center fixed;
...
function choose_bg() {
	...
	$('body').css('background-image', 'url(<?php echo ADMIN_IMG_URL;?>/loginbg_0'+ bg +'.jpg)');
}
</script>
</head>
<body>
        ...
        <div class="login_form">
    		...
    		<form action="index.html" id="login_form" method="post">
    			...
    			<div class="form-group">
    				...
    				<img id="captcha_img" alt="点击更换" title="点击更换" src="<?php echo ADMIN_IMG_URL;?>/captcha.jpeg" class="m">
    			</div>
    			<div class="form-group">
                    <label class="t"></label>
